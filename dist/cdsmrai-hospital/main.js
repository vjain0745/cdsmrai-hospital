...
/* harmony import */ var _core_left_sidebar_left_sidebar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./core/left-sidebar/left-sidebar.component */ "./src/app/core/left-sidebar/left-sidebar.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 6, vars: 2, consts: [[1, "containerdiv", 3, "resize"], ["class", "leftsidebar", 4, "ngIf"], [1, "rightside-layout"], [1, "right_containerDiv"], ["class", "header", 4, "ngIf"], [1, "leftsidebar"], [1, "header"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 32, vars: 11, consts: [[1, "containerDiv", "flexsb"], [1, "leftgrey"], [1, "desk_leftscreen", 2, "background-image", "url(/assets/images/signin_image.png)"], [1, "logo"], ["src", "/assets/logo.jpeg", "alt", "", 1, "dekstopview"], ["src", "/assets/mobile/mobil-logo.png", "alt", "", 1, "ipadview"], [1, "desk_rightscreen"], [1, "loginbox"], [1, "comman_heading", "ipadview"], [1, "comman_heading", "dekstopview"], [1, "comman_headingtext"], [3, "formGroup"], [1, "floating-label-group"], ["type", "text", "id", "username", "autocomplete", "off", "required", "", "formControlName", "email"], [1, "floating-label", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["class", "invalid", 4, "ngIf"], ["type", "password", "id", "password", "autocomplete", "off", "required", "", "formControlName", "password"], [1, "forgott", "buttontext", 3, "click"], ["id", "loginButtons", 1, "buttondiv"], ["type", "submit", 1, "common_button", 3, "click"], [1, "invalid-feedback"], [1, "invalid"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
...
class ServiceService {
    ...
    login(data) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].url + "/loginAdmin", data);
    }
}
